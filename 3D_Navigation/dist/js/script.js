...
document.addEventListener('DOMContentLoaded', function () {
    ...
    // --- College Info Popup Elements (Old) ---
    ...
    // --- NEW 2-Page College Details Popup Elements ---
    const collegeDetailsPopupContainer = document.getElementById('college-details-popup-container');
    const collegeDetailsCloseBtn = document.getElementById('college-details-close-btn');
    const collegeDetailsTitle = document.getElementById('college-details-title');
    const collegeDetailsPage1 = document.getElementById('college-details-page-1');
    const collegeDetailsPage2 = document.getElementById('college-details-page-2');
    const collegeDetailsPrevBtn = document.getElementById('college-details-prev-btn');
    const collegeDetailsNextBtn = document.getElementById('college-details-next-btn');
    const pageIndicator1 = document.getElementById('page-indicator-1');
    const pageIndicator2 = document.getElementById('page-indicator-2');
    let currentCollegeDetailsPage = 1;
    ...
    // --- REVISED Unity and 3D View Elements ---
    ...
    function showPage(pageElement) {
        ...
        if (pageElement === menuPage) {
            preloadUnityInstance();
        }
    }
    ...
    window.translations = {
        ...
        ko: {
            ...
            popupFeatureComingSoon: "이機能は 곧 제공될 예정입니다!", popupNoticeTitle: "알림", popupSuccessTitle: "성공", popupOkButton: "확인",
        ...
        zh: {
            ...
            aboutIntro: "欢迎来到大学3D导航系统 – LSPU，圣巴勃罗市。这是一个开創性的数字计划，旨在增强学生、教职员工和访客探索大学环境并与之互动的方式。",
            ...
            welcomePopupMVTitle: "使命与愿景", welcomePopupMissionTitle: "使命", welcomePopupMissionText: "在进步领导力的推动下，LSPU是一所一流的机构，提供技术媒介的農業、渔业及其他相关和新兴学科，为地区和国家的发展做出了重大贡献。", welcomePopupVisionTitle: "愿景", welcomePopupVisionText: "LSPU是一个技术创新中心，促进跨学科学习、资源的可持续利用，以及与社区和利益相关者的合作与伙伴关系。"
        },
        pt: {
            ...
            welcomeHistory1: "A Universidade Politécnica Estadual de Laguna (LSPU), fundada em 1952, começou como Escola Secundária Provincial de Baybay e evoluiu para seu status universitário atual sob a Lei da República nº 9402 em 2007. É uma institution pública, sem fins lucrativos, reconhecida pela Comissão de Educação Superior (CHED) e pela Agência de Credenciamento de Faculdades e Universidades (AACCUP), oferecendo uma variedade de programas de graduação e pós-graduação em seus múltiplos campi.",
        ...
        es: {
            ...
            loadingWelcomeVisitor: "¡Bienvenido a la Universidad Politécnica Estatal de Laguna – Campus de la Ciudad de San Pablo! Siéntete libre de explorar y conocer los terrenos de nossa universidade. Ya sea que estés aquí para un evento, una reunión o simplemente un recorrido rápido, ¡nuestro mapa 3D está aqui para guiarte en cada paso del camino!",
    ...
    const collegeDetailsData = {
        cas: {
            ...
            page1: `<h3>Vision</h3><p>The College of Arts and Sciences aims to be a global leader in liberal arts education, promoting intellectual freedom, diversity, and inclusion across various disciplines.</p>
                    <h3>Mission</h3><p>CAS focuses on nurturing intellectual curiosity, respect, love of humanity, and humility, while promoting effective civic engagement and research.</p>
                    <h3>Program Educational Objectives (PEO)</h3><p>Graduates of the college are expected to:</p>
                    <ol><li>Advance their careers in arts and sciences.</li><li>Be globally competitive by pursuing continuous professional development, maintaining high ethical standards, and promoting social responsibility.</li></ol>`,
            page2: `<h3>Programs</h3>
                    <ul><li>Bachelor of Science in Biology (BSBio)</li><li>Bachelor of Science in Psychology (BSPsych)</li></ul>`
        },
        cbaa: {
            title: 'College of Business Administration and Accountancy (CBAA)',
            page1: `<h3>Vision</h3><p>The College of Business, Administration, and Accountancy aims to be a globally recognized institution that promotes academic excellence, ethical practices, social responsibility, diversity, and intellectual freedom.</p>
                    <h3>Mission</h3><p>CBAA aims to offer quality education, empowering students to become successful, competent, and ethical business professionals through an interdisciplinary curriculum, producing experts and civic-minded graduates.</p>
                    <h3>Program Educational Objectives (PEO)</h3><p>Graduates of CBAA will:</p>
                    <ol><li>Demonstrate expertise and success in their chosen fields of business, accounting, and administration.</li><li>Be globally competitive by pursuing continuous professional growth and maintaining the highest standards of integrity and excellence.</li><li>Uphold ethical values and social responsibility while contributing to the advancement of their profession.</li></ol>`,
            page2: `<h3>Programs</h3>
                    <ul><li>Bachelor of Science in Office Administration (BSOA)</li><li>Bachelor of Science in Business Administration (BSBA)</li><ol><li>Financial Management (BSBA-FM)</li><li>Marketing Management (BSBA-MM)</li></ol><li>Bachelor of Science in Accountancy (BSA)</li></ul>`
        },
        ccs: {
            title: 'College of Computer Studies (CCS)',
            page1: `<h3>Vision</h3><p>The College of Computer Studies aims to be a top technology institution, producing globally competitive professionals in Information Technology and Computer Science, fostering innovation, research, integrity, intellectual freedom, and social responsibility.</p>
                    <h3>Mission</h3><p>CCS provides top-notch education, preparing students for skilled IT professionals through interdisciplinary approaches, focusing on advanced technologies, innovation, and critical thinking to meet global industry demands.</p>
                    <h3>Program Educational Objectives (PEO)</h3><p>Graduates of CCS will:</p>
                    <ol><li>Excel in software development, networking, and other IT fields.</li><li>Be globally competitive by pursuing continuous professional growth and maintaining high ethical standards.</li><li>Demonstrate leadership and social responsibility in the application of technology to solve real-world problems.</li></ol>`,
            page2: `<h3>Programs</h3>
                    <ul><li>Bachelor of Science in Information Technology (BSInfoTech) - Third Year Standing:</li><ol><li>Animation and Motion Graphics (BSInfoTech-AMG)</li><li>Service Management Program (BSInfoTech-SMP)</li><li>Web and Mobile Application Development (BSInfoTech-WMAD)</li></ol><li>Bachelor of Science in Computer Science (BSCS) - Third Year Standing:</li><ol><li>Graphics and Visualization (BSCS-GV)</li></ol><li>After graduate: Master in Information Technology (MIT)</li></ul>`
        },
        ccje: {
            title: 'College of Criminal Justice Education (CCJE)',
            page1: `<h3>Vision</h3><p>The College of Criminal Justice Education aims to produce competent, ethically grounded professionals in criminology and related fields, fostering an environment of social responsibility, integrity, and academic rigor.</p>
                    <h3>Mission</h3><p>CCJE offers high-quality education, preparing students with knowledge, skills, and ethical values for a successful career in the criminal justice system through community involvement, research, and professional development.</p>
                    <h3>Program Educational Objectives (PEO)</h3><p>Graduates of the BS Criminology program will:</p>
                    <ol><li>Be well-prepared to pursue careers in law enforcement, crime investigation, security management, and related fields.</li><li>Demonstrate strong ethical standards and a commitment to social justice.</li><li>Contribute to the improvement of the criminal justice system through continuous professional development.</li></ol>`,
            page2: `<h3>Programs</h3>
                    <ul><li>Bachelor of Science in Criminology (BSCrim)</li></ul>`
        },
        coe: {
            title: 'College of Engineering (COE)',
            page1: `<h3>Vision</h3><p>The College of Engineering is a top institution in engineering education, focusing on producing skilled professionals in electronics, electrical, and computer engineering, fostering innovation and ethical practices.</p>
                    <h3>Mission</h3><p>COE offers quality engineering education, focusing on knowledge, technical skills, and ethical values, through research, hands-on learning, and community engagement to advance technology and society.</p>
                    <h3>Program Educational Objectives (PEO)</h3><p>Graduates of the engineering programs will:</p>
                    <ol><li>Be well-prepared for careers in electronics, electrical, and computer engineering industries.</li><li>Demonstrate strong problem-solving skills and the ability to apply engineering principles in real-world scenarios.</li><li>Contribute to societal development through continuous learning, research, and ethical practices in their engineering careers.</li></ol>`,
            page2: `<h3>Programs</h3>
                    <ul><li>Bachelor of Science in Electronics Engineering (BSECE)</li><li>Bachelor of Science in Electrical Engineering (BSEE)</li><li>Bachelor of Science in Computer Engineering (BSCpE)</li></ul>`
        },
        cit: {
            title: 'College of Industrial Technology (CIT)',
            page1: `<h3>Vision</h3><p>The College of Industrial Technology aims to become a top institution in producing skilled professionals in industrial technology, fostering ethical practices, social responsibility, and technological advancement through innovative learning experiences.</p>
                    <h3>Mission</h3><p>CIT provides quality education in industrial technology, focusing on technical skills, knowledge, and values, through practical training, research, and community engagement, catering to industry needs.</p>
                    <h3>Program Educational Objectives (PEO)</h3><p>Graduates of the BSIT program will:</p>
                    <ol><li>Be prepared for careers in their chosen field of industrial technology, including automotive, electronics, and construction.</li><li>Demonstrate strong technical abilities and problem-solving skills through practical application.</li><li>Contribute to the advancement of industry by adhering to ethical standards and promoting sustainability in their professional practices.</li></ol>`,
            page2: `<h3>Programs</h3>
                    <ul><li>Bachelor of Science in Industrial Technology (BSIT)</li><ol><li>Automotive Technology (BSIT-AT)</li><li>Architectural Drafting (BSIT-AD)</li><li>Electrical Technology (BSIT-ELT)</li><li>Electronics Technology (BSIT-ELX)</li><li>Food and Beverage Preparation and Service Management Technology (BSIT-FBPSM)</li><li>Heating, Ventilating, Air-Conditioning and Refrigeration Technology (BSIT-HVACR)</li></ol></ul>`
        },
        chmt: {
            title: 'College of International Hospitality and Tourism Management (CIHTM)',
            page1: `<h3>Vision</h3><p>The College of International Hospitality and Tourism Management at LSPU aims to produce globally competitive professionals in hospitality and tourism management, focusing on academic excellence, ethical practices, innovation, and sustainability.</p>
                    <h3>Mission</h3><p>CIHTM offers top-notch education in hospitality and tourism management, focusing on practical skills, knowledge, and values, fostering hands-on learning, customer service excellence, and community engagement.</p>
                    <h3>Program Educational Objectives (PEO)</h3><p>Graduates of the BSHM and BSTM programs will be:</p>
                    <ol><li>Competent professionals in hospitality and tourism management.</li><li>Proficient in customer service and business operations.</li><li>Able to demonstrate leadership and management skills.</li><li>Contributors to industry growth with sustainability, ethical practices, and cultural sensitivity.</li></ol>`,
            page2: `<h3>Programs</h3>
                    <ul><li>Bachelor of Science in Hospitality Management (BSHM)</li><li>Bachelor of Science in Tourism Management (BSTM)</li></ul>`
        },
        cte: {
            title: 'College of Teacher Education (CTE)',
            page1: `<h3>Vision</h3><p>The College of Teacher Education at LSPU aims to produce competent, ethical, and globally competitive educators, fostering a culture of academic excellence, innovative teaching, and social responsibility.</p>
                    <h3>Mission</h3><p>CTE aims to offer quality teacher training through interdisciplinary learning, practical experience, and research, fostering caring, professional educators to positively impact society and the education system.</p>
                    <h3>Program Educational Objectives (PEO)</h3><p>Graduates of the Teacher Education programs will:</p>
                    <ol><li>Be effective educators in their respective fields, applying best practices in teaching and classroom management.</li><li>Demonstrate leadership skills and commitment to lifelong learning, adapting to the evolving educational needs of society.</li><li>Uphold ethical standards, practice civic responsibility, and promote inclusive education for diverse learners.</li></ol>`,
            page2: `<h3>Programs</h3>
                    <ul>
                        <li>Bachelor of Secondary Education (BSEd)</li>
                        <ol><li>English (BSEd-English)</li><li>Filipino (BSEd-Filipino)</li><li>Mathematics (BSEd-Math)</li><li>Science (BSEd-Science)</li><li>Social Science (BSEd-SocSci)</li></ol>
                        ...
                        <ol><li>Home Economics (BTLEd-HE)</li><li>Industrial Arts (BTLEd-IA)</li></ol>
                        <li>Bachelor of Technical Vocational Teacher Education (BTVTEd)</li>
                        <ol><li>Electrical Technology (BTVTEd-ELT)</li><li>Electronics Technology (BTVTEd-ELTS)</li><li>Food and Service Management (BTVTED-FSM)</li><li>Garments, Fashion and Design (BTVTED-GFD)</li></ol>
                        <li>Post graduate</li>
                        <ol><li>Certificate in Teaching Proficiency (CTP)</li></ol>
                    </ul>`
        }
    };
    
    const pinData = [
        { id: 1, title: 'MAIN GATE', icon: 'fa-archway' },
        { id: 2, title: 'GUARD HOUSE', icon: 'fa-person-military-pointing' },
        { id: 3, title: 'BUSINESS CENTER BUILDING', icon: 'fa-store' },
        { id: 4, title: 'CHAPEL', icon: 'fa-church' },
        { id: 5, title: 'ADMINISTRATION BUILDING', icon: 'fa-house-user' },
        { id: 6, title: 'COLLEGE OF TEACHER EDUCATION (CTE BUILDING)', icon: 'fa-chalkboard-teacher', collegeKey: 'cte' },
        { id: 7, title: 'COLLEGE OF TEACHER EDUCATION (CTE BUILDING)', icon: 'fa-chalkboard-teacher', collegeKey: 'cte' },
        { id: 8, title: 'COLLEGE OF TEACHER EDUCATION (CTE BUILDING)', icon: 'fa-chalkboard-teacher', collegeKey: 'cte' },
        { id: 9, title: 'COLLEGE OF TEACHER EDUCATION (CTE BUILDING)', icon: 'fa-chalkboard-teacher', collegeKey: 'cte' },
        { id: 10, title: 'COLLEGE OF BUSINESS MANAGEMENT AND ACCOUNTANCY (CBMA BUILDING)', icon: 'fa-briefcase', collegeKey: 'cbaa' },
        { id: 11, title: 'HOSTEL', icon: 'fa-bed' },
        { id: 12, title: 'CANTEEN', icon: 'fa-utensils' },
        { id: 13, title: 'CLINIC', icon: 'fa-clinic-medical' },
        { id: 14, title: 'LIBRARY', icon: 'fa-book-open' },
        { id: 15, title: 'TENNIS COURT', icon: 'fa-table-tennis-paddle-ball' },
        { id: 16, title: 'COLEGE OF COMPUTER STUDIES (NEW CCS BUILDING)', icon: 'fa-laptop-code', collegeKey: 'ccs' },
        { id: 17, title: 'CIT BLDG ELECTRONICS TECHNOLOGY BUILDING', icon: 'fa-microchip', collegeKey: 'cit' },
        { id: 18, title: 'RESEARCH CENTER', icon: 'fa-flask' },
        { id: 19, title: 'CIT BLDG & AUTOMOTIVE TECHNOLOGY BUILDING', icon: 'fa-car-wrench', collegeKey: 'cit' },
        { id: 20, title: 'COLLEGE OF ENGINEERING (COE BUILDING)', icon: 'fa-cogs', collegeKey: 'coe' },
        { id: 21, title: 'MULTI-TECH BUILDING', icon: 'fa-screwdriver-wrench', collegeKey: 'cit' },
        { id: 22, title: 'COLEGE OF COMPUTER STUDIES (OLD CCS BUILDING)', icon: 'fa-laptop-code', collegeKey: 'ccs' },
        { id: 23, title: 'NSTP OFFICE AND EXTENSION SERVICES OFFICE', icon: 'fa-flag' },
        { id: 24, title: 'CIT BLDG. FOOD AND BEVERAGE PREPARATION SERVICES MANAGEMENT BUILDING', icon: 'fa-burger-soda', collegeKey: 'cit' },
        { id: 25, title: 'GENDER AND DEVELOPMENT OFFICE', icon: 'fa-venus-mars' },
        { id: 26, title: 'GYMNASIUM', icon: 'fa-basketball' },
        { id: 27, title: 'FIELD AND PARKING AREA', icon: 'fa-futbol' },
        { id: 28, title: 'GARAGE', icon: 'fa-car' },
        { id: 29, title: 'ALUMNI BUILDING', icon: 'fa-graduation-cap' },
        { id: 30, title: 'DOST BUILDING-PSTC BUILDING', icon: 'fa-satellite-dish' },
        { id: 31, title: 'COLLEGE OF HOSPITALITY MANAGEMENT AND TOURISM (CHMT BUILDING)', icon: 'fa-concierge-bell', collegeKey: 'chmt' },
        { id: 32, title: 'HOSTEL 2', icon: 'fa-bed' },
        { id: 33, title: 'STUDENT SERVICES COUNCIL OFFICE', icon: 'fa-users' },
        { id: 34, title: 'STUDENT ACTIVITY CENTER', icon: 'fa-award' },
        { id: 35, title: 'VOLLEYBALL COURT', icon: 'fa-volleyball' },
        { id: 36, title: 'SEPAK TAKRAW COURT', icon: 'fa-person-running' },
        { id: 37, title: 'GENERAL EDUCATION BUILDING', icon: 'fa-school', collegeKey: 'cas' },
        { id: 38, title: 'GENERAL EDUCATION BUILDING', icon: 'fa-school', collegeKey: 'cas' },
        { id: 39, title: 'GENERAL EDUCATION BUILDING', icon: 'fa-school', collegeKey: 'cas' },
        { id: 40, title: 'GENERAL EDUCATION BUILDING AND SPORTS CENTER', icon: 'fa-school', collegeKey: 'cas' },
        { id: 41, title: 'AMPITHEATER', icon: 'fa-masks-theater' },
        { id: 42, title: 'SWIMMING POOL', icon: 'fa-person-swimming' },
        { id: 43, title: 'TESDA BUILDING/CIT BUILDING', icon: 'fa-tools', collegeKey: 'cit' },
        { id: 44, title: 'CCJE FIRING RANGE', icon: 'fa-crosshairs', collegeKey: 'ccje' }
    ];
    ...
    pinData.forEach(data => {
        ...
        if (pinElement) {
            pinElement.addEventListener('click', (e) => {
                e.stopPropagation();
                if (data.collegeKey && collegeDetailsData[data.collegeKey]) {
                    showCollegeDetailsPopup(data.collegeKey);
                } else {
    ...
    function showCollegeDetailsPopup(collegeKey) {
        const data = collegeDetailsData[collegeKey];
        if (!data || !collegeDetailsPopupContainer) return;

        collegeDetailsTitle.textContent = data.title;
        collegeDetailsPage1.innerHTML = data.page1;
        collegeDetailsPage2.innerHTML = data.page2;

        currentCollegeDetailsPage = 1;
        updateCollegeDetailsPage();

        collegeDetailsPopupContainer.style.display = 'flex';
    }

    function hideCollegeDetailsPopup() {
        if (collegeDetailsPopupContainer) {
            collegeDetailsPopupContainer.style.display = 'none';
        }
    }

    function updateCollegeDetailsPage() {
        if (currentCollegeDetailsPage === 1) {
            collegeDetailsPage1.classList.add('active-page');
            collegeDetailsPage2.classList.remove('active-page');
            pageIndicator1.classList.add('active');
            pageIndicator2.classList.remove('active');
            collegeDetailsPrevBtn.disabled = true;
            collegeDetailsNextBtn.disabled = false;
        } else {
            collegeDetailsPage1.classList.remove('active-page');
            collegeDetailsPage2.classList.add('active-page');
            pageIndicator1.classList.remove('active');
            pageIndicator2.classList.add('active');
            collegeDetailsPrevBtn.disabled = false;
            collegeDetailsNextBtn.disabled = true;
        }
    }

    if (collegeDetailsNextBtn) {
        collegeDetailsNextBtn.addEventListener('click', () => {
            if (currentCollegeDetailsPage < 2) {
                currentCollegeDetailsPage++;
                updateCollegeDetailsPage();
            }
        });
    }

    if (collegeDetailsPrevBtn) {
        collegeDetailsPrevBtn.addEventListener('click', () => {
            if (currentCollegeDetailsPage > 1) {
                currentCollegeDetailsPage--;
                updateCollegeDetailsPage();
            }
    ...
    if (collegeDetailsCloseBtn) {
        collegeDetailsCloseBtn.addEventListener('click', hideCollegeDetailsPopup);
    }
    if (collegeDetailsPopupContainer) {
        collegeDetailsPopupContainer.addEventListener('click', (e) => {
            if (e.target === collegeDetailsPopupContainer) {
                hideCollegeDetailsPopup();
            }
        });
    }
    ...
    function preloadUnityInstance() {
        if (isUnityLoading || isUnityLoaded) return;
        isUnityLoading = true;
        console.log("Starting Unity pre-load in the background...");

        const wrapper = document.querySelector('.character-canvas-wrapper');
        unityCanvas.width = wrapper.clientWidth;
        unityCanvas.height = wrapper.clientHeight;
        ...
        const config = {
            ...
            productName: "3D_Navigation",
            productVersion: "0.1",
        };

        createUnityInstance(unityCanvas, config, (progress) => {
            console.log(`Unity Pre-loading Progress: ${Math.round(progress * 100)}%`);
        }).then((instance) => {
            unityInstance = instance;
            isUnityLoading = false;
            isUnityLoaded = true;
            console.log("Unity instance pre-loaded successfully and is ready.");
        }).catch((message) => {
            alert(`Error pre-loading Unity: ${message}`);
            isUnityLoading = false;
        });
    }
    ...
    function switchToMapView() {
        if (!isUnityLoaded) {
            console.log("Unity is still loading, please wait...");
            mapViewBtn.innerHTML = '<i class="fas fa-spinner fa-spin"></i>'; 

            const waitInterval = setInterval(() => {
                if (isUnityLoaded) {
                    clearInterval(waitInterval);
                    mapViewBtn.innerHTML = '<i class="fas fa-map-location-dot"></i>';
                    switchToMapView();
                }
            }, 100);
            return;
        ...
        if (characterCanvasContainer) characterCanvasContainer.style.display = 'none';
        ...
        if (unityContainer) {
            ...
            setTimeout(() => {
                unityContainer.style.transition = 'opacity 0.5s ease-in-out';
    ...
    function switchToCharacterView() {
        if (unityContainer) {
            unityContainer.style.transition = 'opacity 0.3s ease-in-out';
            unityContainer.style.opacity = '0';
            setTimeout(() => {
        ...
        if (characterCanvasContainer) characterCanvasContainer.style.display = 'block';
    ...
    if (charBackToMenuBtn) {
        charBackToMenuBtn.addEventListener('click', (e) => {
            e.preventDefault();
            bodyElement.classList.remove('unity-fullscreen-active');
            characterSelectionPage.classList.remove('fullscreen-active');
            showPage(menuPage);
        });
    }
    ...
    if (charFullscreenBtn) {
        charFullscreenBtn.addEventListener('click', (e) => {
            ...
            if (isMapViewActive) {
                bodyElement.classList.toggle('unity-fullscreen-active');
                const isUnityFullscreen = bodyElement.classList.contains('unity-fullscreen-active');
                ...
                const isThreeJsFullscreen = characterSelectionPage.classList.contains('fullscreen-active');
    
                if (isThreeJsFullscreen) {
                    icon.classList.remove('fa-expand');
                    icon.classList.add('fa-compress');
