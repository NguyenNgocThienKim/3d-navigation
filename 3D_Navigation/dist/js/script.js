...
document.addEventListener('DOMContentLoaded', function () {
    ...
    function loadCharacter(index) {
        ...
        loader.load(characterModels[index], (gltf) => {
            ...
            // --- START: ROBUST CENTERING AND SCALING LOGIC ---
    ...
    if (loadMapBtn) {
        loadMapBtn.addEventListener('click', (e) => {
            e.preventDefault();
            // This button now does nothing, as requested.
        });
    }
    ...
    if (charFullscreenBtn) {
        charFullscreenBtn.addEventListener('click', (e) => {
            ...
            if (isFullscreen) {
                ...
                if (isMapView && defaultMapState.position) {
                ...
                icon.classList.remove('fa-compress');
                icon.classList.add('fa-expand');
                if (isMapView && defaultMapState.target && defaultMapState.position) {
